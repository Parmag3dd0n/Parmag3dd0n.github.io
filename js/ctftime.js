...
fetch(apiUrl).then(response => {
	...
	const countryPlace = (rating && rating.country_place !== undefined)
		? rating.country_place + getOrdNumber(rating.country_place) : "temporarily unavailable";
	const ratingPlace = (rating && rating.rating_place !== undefined)
		? rating.rating_place + getOrdNumber(rating.rating_place) : "temporarily unavailable";
